...
5. Create a GitHub release for `v0.1.0` using the notes above.
6. Build and publish the `colophon-site` distribution to PyPI from a clean checkout with release credentials.
